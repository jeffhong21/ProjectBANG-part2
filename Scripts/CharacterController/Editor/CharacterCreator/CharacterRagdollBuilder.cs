...
{
    class CharacterRagdollBuilder : ScriptableWizard
    {
        [Header("--  Animator --")]
        ...
        static void CreateWizard()
        {
            ...
            var character = Selection.activeGameObject;
            if(character && character.GetComponent<Animator>())
            {
                builder.animator = character.GetComponent<Animator>();


                builder.pelvis = builder.animator.GetBoneTransform(HumanBodyBones.Hips).transform;

                builder.leftHips = builder.animator.GetBoneTransform(HumanBodyBones.LeftUpperLeg).transform;
                builder.leftKnee = builder.animator.GetBoneTransform(HumanBodyBones.LeftLowerLeg).transform;
                builder.leftFoot = builder.animator.GetBoneTransform(HumanBodyBones.LeftFoot).transform;

                builder.rightHips = builder.animator.GetBoneTransform(HumanBodyBones.RightUpperLeg).transform;
                builder.rightKnee = builder.animator.GetBoneTransform(HumanBodyBones.RightLowerLeg).transform;
                builder.rightFoot = builder.animator.GetBoneTransform(HumanBodyBones.RightFoot).transform;

                builder.leftArm = builder.animator.GetBoneTransform(HumanBodyBones.LeftUpperArm).transform;
                builder.leftElbow = builder.animator.GetBoneTransform(HumanBodyBones.LeftLowerArm).transform;

                builder.rightArm = builder.animator.GetBoneTransform(HumanBodyBones.RightUpperArm).transform;
                builder.rightElbow = builder.animator.GetBoneTransform(HumanBodyBones.RightLowerArm).transform;

                builder.middleSpine = builder.animator.GetBoneTransform(HumanBodyBones.Spine).transform;

                builder.head = builder.animator.GetBoneTransform(HumanBodyBones.Head).transform;
